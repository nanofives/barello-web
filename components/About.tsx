...
export default function About() {
  ...
  const teamMembers = [
    { id: 1, name: 'Miembro 1', image: '/14753ff8-7e9a-4887-87f3-2ee90eb532b1.png' },
    { id: 2, name: 'Miembro 2', image: '/84c2932d-5812-4733-bdb8-5171d6f807a8.png' },
    { id: 3, name: 'Miembro 3', image: '/ad55171e-dd86-434c-8ab7-b0454288b420.png' },
    { id: 4, name: 'Miembro 4', image: '/e3520843-a053-44e1-99c4-73526b85c6c3.png' },
    { id: 5, name: 'Miembro 5', image: '/f482f042-b162-47c9-9546-fc666b46c798.png' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-base text-navy/80 leading-relaxed mb-8 text-justify">
